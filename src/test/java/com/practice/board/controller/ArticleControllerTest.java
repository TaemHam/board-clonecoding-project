...
import com.practice.board.config.SecurityConfig;
...
import com.practice.board.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @DisplayName("[view][GET] 게시글 페이지 - 검색어와 함께 호출")
    @Test
    ...
    @DisplayName("[view][GET] 게시글 페이지 - 페이징, 정렬 기능")
    @Test
    ...
    void givenNothing_whenRequestingArticleView_thenReturnsArticleView() throws Exception {
        ...
        mvc.perform(get("/articles/" + articleId))
                ...
                .andExpect(model().attributeExists("article"))                .andExpect(model().attributeExists("articleComments"))
    ...
    @WithUserDetails(value = "tester", userDetailsServiceBeanName = "userDetailsService", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    ...
    @WithUserDetails(value = "testUser", userDetailsServiceBeanName = "userDetailsService", setupBefore = TestExecutionEvent.TEST_EXECUTION)
